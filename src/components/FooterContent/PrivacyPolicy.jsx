...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="text-lg space-y-8" data-aos="fade-up">
      ...
      <ul className="space-y-6">
        ...
        <li>
          <p>
            ...
            this Agreement) refers to SellKaro.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SellKaro, accessible from{" "}
            <a
              href="netlify.com"
      ...
      <h3 className="font-bold text-2xl">Types of Data Collected</h3>
      <h4 className="font-bold text-xl">Personal Data</h4>
      <p>
      ...
      <h4 className="font-bold text-xl">Usage Data</h4>
      ...
      <h4 className="font-bold text-xl">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h3 className="font-bold text-2xl">Use of Your Personal Data</h3>
      ...
      <h3 className="font-bold text-2xl">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-2xl">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-2xl">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-2xl">Disclosure of Your Personal Data</h3>
      <h4 className="font-bold text-xl">Business Transactions</h4>
      <p>
      ...
      <h4 className="font-bold text-xl">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="font-bold text-xl">Other legal requirements</h4>
      <p>
      ...
      <h3 className="font-bold text-2xl">Security of Your Personal Data</h3>
      <p>
      ...
      <ul>
        <li>By email: snehashisroyofficial@gmail.com</li>
      </ul>
    </div>
  );
};
