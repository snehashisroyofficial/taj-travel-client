...
const Disclaimer = () => {
  ...
  return (
    <div className="text-lg space-y-8   " data-aos="fade-up">
      <Helmet>
        <title>Disclaimer</title>
      </Helmet>
      <h1 className="font-bold text-3xl">Disclaimer for Taj Travel</h1>

      <p>
        If you require any more information or have any questions about our
        site's disclaimer, please feel free to contact us by email at
        snehashisroyofficial@gmail.com. Our Disclaimer was generated with the
        help of the .
      </p>

      <h2 className="font-bold">Disclaimers for Taj Travel</h2>

      <p>
        All the information on this website - real-estate-assignment-09.web.app
        - is published in good faith and for general information purpose only.
        Taj Travel does not make any warranties about the completeness,
        reliability and accuracy of this information. Any action you take upon
        the information you find on this website (Taj Travel), is strictly at
        your own risk. Taj Travel will not be liable for any losses and/or
